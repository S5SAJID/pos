...
import { Boxes, MoreHorizontal, Pencil, Plus, SearchIcon } from 'lucide-react'
      ...
      },
      {
        ...
        renderCell: (item) => (
          <DropdownMenu
            ...
            alignment="end"
            button={{
              label: `Actions for ${item.productName}`,
            ...
            items={[
              {
                ...
                onClick: () => {
                  setPreselectedProductId(item.productId)
                  setIsAddOpen(true)
                },
              },
              {
